...
It can set/get values for the person like First Name, Last Name, etc..
It has a toString() method that has been specifically designed to write to the data file
...
namespace Asg3_dds160030
{
    ...
    public class MyObject
    {
        ...
        //backspace count
        //sets backspacevalue to backspace
        //gets backspace
        private string backspacevalue;
        public string backspace
        {
            get { return backspacevalue; }
            set { backspacevalue = value; }
        }
        ...
        {
            return this.FirstName + "\t" + this.LastName + "\t" + this.Minit + "\t" + this.Add1 + "\t" + this.Add2 + "\t" + this.City + "\t" + this.State + "\t" + this.ZipCode + "\t" + this.Phone + "\t" + this.Email + "\t" + this.ProofofPurchase.ToString() + "\t" + this.Date + "\t" + this.startTime + "\t" + this.endTime + "\t" + this.backspace;
        }
